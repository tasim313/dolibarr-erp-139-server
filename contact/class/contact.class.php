...
class Contact extends CommonObject
{
	...
	public function create($user)
	{
		...
		$sql .= "'".$this->db->escape($this->lastname)." - ".$this->db->escape($this->poste)."'";
		$sql .= ")";
	...
	public function update($id, $user = null, $notrigger = 0, $action = 'update', $nosyncuser = 0)
	{
		...
		$sql .= ", note_private = '".$this->db->escape($this->lastname)." - ".$this->db->escape($this->poste)."'";
	...
	public function fetch($id, $user = null, $ref_ext = '', $email = '', $loadalsoroles = 0)
	{
		...
		if ($resql) {
			...
			if ($num > 1) {
				...
				// $this->note_private	= $obj->lastname . " - " . $obj->poste;
