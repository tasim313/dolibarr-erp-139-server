...
class Thirdparties extends DolibarrApi
{
	...
	/**
	 * Get properties of a thirdparty object by phone.
	 *
	 * Return an array with thirdparty informations
	 *
	 * @param string    $phone  Phone of third party to load
	 * @return array|mixed Cleaned Societe object
	 *
	 * @url     GET phone/{phone}
	 *
	...
	{
		return $this->_fetch('', '', '', '', '', '', '', '', '', '', '', '', $phone);
	}

	/**
	 * Get properties of a thirdparty object by fax.
	 *
	 * Return an array with thirdparty informations
	 *
	 * @param string    $fax  Fax of third party to load
	 * @return array|mixed Cleaned Societe object
	 *
	 * @url     GET fax/{fax}
	 *
	 ...
	 * @throws RestException
	 */
	private function _fetch($rowid, $ref = '', $ref_ext = '', $barcode = '', $idprof1 = '', $idprof2 = '', $idprof3 = '', $idprof4 = '', $idprof5 = '', $idprof6 = '', $email = '', $ref_alias = '', $phone = '', $fax = '')
	{
		global $conf;
		...
		if ($rowid === 0) {
			...
			$result = $this->company->fetch($rowid, $ref, $ref_ext, $barcode, $idprof1, $idprof2, $idprof3, $idprof4, $idprof5, $idprof6, $email, $ref_alias, $phone, $fax);
		}
		if (!$result) {
			throw new RestException(404, 'Thirdparty not found');
		}
