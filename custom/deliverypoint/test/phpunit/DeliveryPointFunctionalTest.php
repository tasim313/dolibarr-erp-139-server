...
/**
 * \file    test/phpunit/DeliveryPointFunctionalTest.php
...
/**
 * Class DeliveryPointFunctionalTest
 *
 ...
 *
 * @package Testdeliverypoint
 */
class DeliveryPointFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDeliveryPoint')->click();
		} else {
			// Disable the module
			$this->byHref('modDeliveryPoint')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/deliverypoint/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('deliverypoint/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/deliverypoint/admin/about.php');
		$this->authenticate();
		return $this->assertContains('deliverypoint/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('deliverypointwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDeliveryPoint_DeliveryPointTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDeliveryPoint_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
