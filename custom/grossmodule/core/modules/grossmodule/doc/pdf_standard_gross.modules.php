...
/**
 *  \file       core/modules/grossmodule/doc/pdf_standard.modules.php
 *  \ingroup    grossmodule
...
/**
 *	Class to manage PDF template standard_gross
 */
class pdf_standard_gross extends ModelePDFGross
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_GROSS_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->grossmodule->dir_output.'/gross') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->grossmodule->dir_output.'/gross';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->grossmodule->dir_output.'/gross/'.$objectref;
