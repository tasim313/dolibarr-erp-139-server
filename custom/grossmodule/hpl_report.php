...
// SQL operation for report comment
$report_comment_sql = "
    ...
    WHERE cmd.ref = '$LabNumberWithoutPrefix' AND c.element_type = 'Final Report'
    ORDER BY c.rowid DESC
    LIMIT 1
";

$report_comment_result = pg_query($pg_con, $report_comment_sql);

// Check if the query executed successfully
if (!$report_comment_result) {
    die("Error in SQL query: " . pg_last_error());
}
...
while ($row = pg_fetch_assoc($report_comment_result)) {
