...
/**
 * \file    test/phpunit/GrossModuleFunctionalTest.php
 * \ingroup grossmodule
...
/**
 * Class GrossModuleFunctionalTest
 *
 ...
 *
 * @package Testgrossmodule
 */
class GrossModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGrossModule')->click();
		} else {
			// Disable the module
			$this->byHref('modGrossModule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/grossmodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('grossmodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/grossmodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('grossmodule/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('grossmodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGrossModule_GrossModuleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGrossModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
