...
<div class="content">
    ...
    <div>
      ...
      <?php if (!$isGrossAssistant && !empty($doctor_name)) { ?>
    <input type="hidden" id="gross_doctor_name" name="gross_doctor_name" value="<?php echo htmlspecialchars($doctor_name); ?>">
    <?php } elseif (!empty($doctor_name)) { ?>
        ...
        <select id="gross_doctor_name" name="gross_doctor_name">
            ...
            foreach ($doctors as $doctor) {
                $selected = ($doctor['doctor_username'] == $doctor_name) ? 'selected' : '';
