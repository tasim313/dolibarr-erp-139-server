...
/**
 * \file    test/phpunit/HistoLabFunctionalTest.php
 * \ingroup histolab
 ...
 *
 * @package Testhistolab
 */
class HistoLabFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/histolab/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('histolab/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/histolab/admin/about.php');
		$this->authenticate();
		return $this->assertContains('histolab/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('histolabwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHistoLab_HistoLabTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHistoLab_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
