...
// SQL operation for dynamic data
$micro_details_info = "SELECT description, specimen FROM llx_preliminary_report_microscopic WHERE lab_number = '$LabNumber' ORDER BY row_id ASC";
...
// SQL operation for dynamic data
$diagnosis_details_info  = "SELECT  description, specimen, title, comment FROM llx_preliminary_report_diagnosis WHERE lab_number = '$LabNumber' ORDER BY row_id ASC";
...
$html = '<h4 align="center">(Preliminary Report: Dated ' . $currentDateTime . ')</h4><br>';
