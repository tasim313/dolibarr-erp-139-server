        ...
        <?php
            ...
            echo('<form id="duplicateReportForm" action="../save_duplicate_report_data.php" method="POST">
                ...
                <button class="btn btn-info btn-md" onclick="submitAndRedirect()">
                    <a id="reportLink" href="../duplicate_report/fna/index.php?LabNumber=' . htmlspecialchars($LabNumber, ENT_QUOTES, 'UTF-8') . '&username=' . urlencode($loggedInUsername) . '" target="_blank">Duplicate Report</a>
                </button>'
            );
        ?>
    </div>
