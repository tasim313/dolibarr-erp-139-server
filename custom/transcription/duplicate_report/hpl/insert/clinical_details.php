...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $addressing = $_POST['addressing'] ?? null;
    ...
    if ($checkResult) {
        ...
        if ($row > 0) {
            ...
            $updateSql = "UPDATE llx_other_report_clinical_details 
                          SET clinical_details = $1, addressing = $2, created_user = $3, created_date = NOW() 
                          WHERE lab_number = $4";
            $updateResult = pg_query_params($pg_con, $updateSql, [$clinical_details, $addressing, $created_user, $lab_number]);
            ...
            $insertSql = "INSERT INTO llx_other_report_clinical_details (lab_number, clinical_details, addressing, created_user) 
                          VALUES ($1, $2, $3, $4)";
            $insertResult = pg_query_params($pg_con, $insertSql, [$lab_number, $clinical_details, $addressing, $created_user]);
