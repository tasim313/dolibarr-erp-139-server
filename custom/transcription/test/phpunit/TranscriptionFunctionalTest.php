...
/**
 * \file    test/phpunit/TranscriptionFunctionalTest.php
...
/**
 * Class TranscriptionFunctionalTest
 *
 ...
 *
 * @package Testtranscription
 */
class TranscriptionFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTranscription')->click();
		} else {
			// Disable the module
			$this->byHref('modTranscription')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/transcription/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('transcription/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/transcription/admin/about.php');
		$this->authenticate();
		return $this->assertContains('transcription/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('transcriptionwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTranscription_TranscriptionTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTranscription_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
