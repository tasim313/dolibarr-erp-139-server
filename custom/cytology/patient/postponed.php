...
<body>
    <div class="container">
        <h4>Please confirm if you want to postpone this FANC. You can either exit this page or proceed with the postponement by providing additional information.</h4>
        <br>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to postpone this FANC?
                    </div>
        ...
        <div id="cancelFormContainer" style="display: none; margin-top: 20px;">
            <form action="../Cyto/process_postpone.php" method="POST">
