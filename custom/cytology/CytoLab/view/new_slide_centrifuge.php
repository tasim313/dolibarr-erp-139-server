    ...
    <div class="container">
        <h3>Cyto Lab WorkFlow</h3>
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="./new_slide_centrifuge.php" class="tab">New Slide (Centrifuge)</a></li>
        ...
        <div class="tab-container">
            ...
            <div id="List" class="tabcontent active">
                <div class="container">
                    <!-- Form to input data -->
                    <form method="POST" action="../insert/insert_slide_centrifuge.php">
                        <div class="form-group row">
                            <label for="lab_number" class="col-sm-4 col-form-label">Lab Number:</label>
                            <div class="col-sm-8">
                                <input type="text" id="lab_number" name="lab_number" placeholder="e.g., 2501-00008" class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="slide_number" class="col-sm-4 col-form-label">Slide Numbers:</label>
                            <div class="col-sm-8">
                                <input type="text" id="slide_number" name="slide_number" placeholder="e.g., 250100005FC-A-1, 250100005FC-A-2" class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="pipette_tips" class="col-sm-4 col-form-label">Pipette Tips:</label>
                            <div class="col-sm-8">
                                <input type="text" id="pipette_tips" name="pipette_tips" placeholder="e.g., 2" class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="filter_paper" class="col-sm-4 col-form-label">Filter Paper:</label>
                            <div class="col-sm-8">
                                <input type="text" id="filter_paper" name="filter_paper" placeholder="e.g., 2" class="form-control" required>
                            </div>
                        </div>

                        <!-- Hidden field for created_user -->
            ...
            <div id="Complete" class="tabcontent">
                <h3>Slide  List For Centrifuge</h3>
                ...
                <?php
                    // Fetch data
                    $slide_prepare = cyto_slide_centrifuge_list();
                    // Fields to exclude
                    $excluded_fields = ['rowid'];
