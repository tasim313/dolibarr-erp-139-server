...
/**
 * \file    test/phpunit/CytologyFunctionalTest.php
 * \ingroup cytology
 ...
 *
 * @package Testcytology
 */
class CytologyFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/cytology/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cytology/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cytology/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cytology/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('cytologywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCytology_CytologyTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCytology_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
