...
/**
 * \file    test/phpunit/WorksheetsFunctionalTest.php
 * \ingroup worksheets
...
/**
 * Class WorksheetsFunctionalTest
 *
 ...
 *
 * @package Testworksheets
 */
class WorksheetsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modWorksheets')->click();
		} else {
			// Disable the module
			$this->byHref('modWorksheets')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/worksheets/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('worksheets/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/worksheets/admin/about.php');
		$this->authenticate();
		return $this->assertContains('worksheets/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('worksheetswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWorksheets_WorksheetsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWorksheets_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
