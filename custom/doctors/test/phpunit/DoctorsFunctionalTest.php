...
/**
 * \file    test/phpunit/DoctorsFunctionalTest.php
 * \ingroup doctors
 ...
 * @package Testdoctors
 */
class DoctorsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/doctors/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doctors/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doctors/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doctors/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doctorswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoctors_DoctorsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoctors_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
