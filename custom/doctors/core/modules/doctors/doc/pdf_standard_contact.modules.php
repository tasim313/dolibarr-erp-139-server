...
/**
 *  \file       core/modules/doctors/doc/pdf_standard.modules.php
 *  \ingroup    doctors
...
/**
 *	Class to manage PDF template standard_contact
 */
class pdf_standard_contact extends ModelePDFContact
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_CONTACT_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->doctors->dir_output.'/contact') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->doctors->dir_output.'/contact';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->doctors->dir_output.'/contact/'.$objectref;
