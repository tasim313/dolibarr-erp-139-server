...
$reception = reception_sample_received_list(null, null, 'yesterday');
$receptionJson = json_encode($reception);

$gross = gross_complete_list(null, null, 'yesterday');

$grossJson = json_encode($gross);

$worksheet_tracking = worksheet_tracking_list(null, null, 'yesterday');
$worksheetTrackingJson = json_encode($worksheet_tracking);

$transcription = transcription_complete_list(null, null, 'yesterday');
$transcriptionJson = json_encode($transcription);

$invoice = invoice_list(null, null, 'yesterday');
