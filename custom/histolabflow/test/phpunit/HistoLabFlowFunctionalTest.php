...
/**
 * \file    test/phpunit/HistoLabFlowFunctionalTest.php
...
/**
 * Class HistoLabFlowFunctionalTest
 *
 ...
 *
 * @package Testhistolabflow
 */
class HistoLabFlowFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modHistoLabFlow')->click();
		} else {
			// Disable the module
			$this->byHref('modHistoLabFlow')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/histolabflow/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('histolabflow/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/histolabflow/admin/about.php');
		$this->authenticate();
		return $this->assertContains('histolabflow/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('histolabflowwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHistoLabFlow_HistoLabFlowTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHistoLabFlow_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
