...
/**
 * \file    test/phpunit/ITSPACEFunctionalTest.php
 * \ingroup itspace
 ...
 * @package Testitspace
 */
class ITSPACEFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/itspace/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('itspace/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/itspace/admin/about.php');
		$this->authenticate();
		return $this->assertContains('itspace/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('itspacewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modITSPACE_ITSPACETriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modITSPACE_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
